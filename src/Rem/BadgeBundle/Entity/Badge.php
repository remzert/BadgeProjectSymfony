...
class Badge
{
     ...
     * Add unlock
     *
     * @param \Rem\BadgeBundle\Entity\BadgeUnlock $unlock
     *
     * @return Badge
     */
    public function addUnlock(\Rem\BadgeBundle\Entity\BadgeUnlock $unlock)
    {
        $this->unlocks[] = $unlock;
     ...
     * @param \Rem\BadgeBundle\Entity\BadgeUnlock $unlock
     */
    public function removeUnlock(\Rem\BadgeBundle\Entity\BadgeUnlock $unlock)
    {
